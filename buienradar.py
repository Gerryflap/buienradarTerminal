...
# Download the image
subprocess.check_call(["wget", "http://api.buienradar.nl/image/1.0/RadarMapNL?w=%i&h=%i"%image_size, "-O", "temp.gif"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
